...
const FloatingDockDesktop = ({
  ...
  return (
    ...
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-16 gap-4 items-end  rounded-2xl bg-[#080b22] opacity-100  px-4 pb-3 z-10 -mt-10 mb-5",
        className
      )}
    >
      {items.map((item) => (
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="aspect-square rounded-full bg-[#10132E] opacity-100  flex items-center justify-center relative"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
